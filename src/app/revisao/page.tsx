        ...
        <div className="w-full max-w-xl">
          ...
          <div className="mt-5 flex gap-3">
            ...
            <button
              ...
              onClick={aoGerarPdf}
              disabled={baixando}
              className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-brand-400 px-5 py-3.5 text-sm font-semibold text-zinc-950 shadow-lg shadow-brand-400/20 transition hover:bg-brand-300 disabled:cursor-not-allowed disabled:opacity-60"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
